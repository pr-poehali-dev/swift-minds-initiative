      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4">
            <p className="font-serif text-2xl tracking-wide text-foreground mb-4">Wabi Landscape</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Ландшафтное бюро. Проектируем территории, где природа и человек существуют в гармонии.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Wabi Landscape. Все права защищены.
          </p>
          <p className="text-xs text-muted-foreground">Создано с любовью к природе</p>
        </div>
      </div>
    </footer>
  )
