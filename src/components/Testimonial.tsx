  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Бюро создало для нас сад, который меняется каждый сезон и всегда живой. Они не просто высадили растения — они создали место, куда хочется возвращаться снова и снова.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Елена и Дмитрий Соколовы</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Усадьба в Подмосковье</p>
        </div>
      </div>
    </section>
  )
