      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Каждый ландшафтный проект начинается с разговора о месте и о людях, которые будут здесь жить.
              Напишите нам — и мы назначим первую встречу.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Расскажите об участке и вашем видении..."
                  required
                />
              </div>
              <button
